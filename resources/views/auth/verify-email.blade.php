        ...
        <div class="w-full max-w-md border border-slate-200 rounded-xl p-6 shadow-sm">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" class="underline text-sm text-sky-700 hover:text-sky-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500">
                        {{ __('Log Out') }}
                    </button>
                </form>
            </div>
